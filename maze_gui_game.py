...
class MazeGUI:
    ...
    def create_controls(self):
        ...
        self.canvas.create_window(-95, -340, window=self.reset_button)
        self.canvas.create_window(-35, -340, window=self.path_button)
        self.canvas.create_window(25, -340, window=self.dfs_button)
        self.canvas.create_window(85, -340, window=self.bfs_button)
    ...
    def update_algorithm(self, alg):
        self.algorithm = alg
        buttons = [self.dfs_button, self.bfs_button]
